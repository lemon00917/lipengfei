...
import com.cdutcm.tcms.oauth2.web.filter.Oauth2Filter;
import com.cdutcm.tcms.shiro.UserRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(org.apache.shiro.mgt.SecurityManager securityManager) {
	        ...
	        shiroFilterFactoryBean.getFilters().put("OAUTH2", new Oauth2Filter());
	        ...
	        */
	        ...
	        filterChainDefinitionMap.put("/acesstoken/**", "OAUTH2");
	        filterChainDefinitionMap.put("/oauth2/**", "anon");
	        filterChainDefinitionMap.put("/logout", "logout");
	        // <!-- 过滤链定义，从上向下顺序执行，一般将 /**放在最为下边 -->:这是一个坑呢，一不小心代码就不好使了;
	        // <!-- authc:所有url都必须认证通过才可以访问; anon:所有url都都可以匿名访问-->
	        filterChainDefinitionMap.put("/rigister", "anon");
	        filterChainDefinitionMap.put("/login.html", "anon");
	        filterChainDefinitionMap.put("/userlogin", "anon");
	       
	        filterChainDefinitionMap.put("/css/**", "anon");  
	        filterChainDefinitionMap.put("/easyui/**", "anon");
	        filterChainDefinitionMap.put("/gentelella/**", "anon");
