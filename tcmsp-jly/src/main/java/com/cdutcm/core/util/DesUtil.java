...
public class DesUtil {
	...
	public static void main(String[] args) throws Exception {
		String data = "g8GvpAjOQVdJ9dsS62y/3A==";
		String key = "c29uZ2d1bw==";
		// String key ="123";
		// 2HbQtPDEqqah0WiTqhkSbg==
		// 2HbQtPDEqqah0WiTqhkSbg==
		System.out.println("解密:" + decrypt(data, key));
	}
	...
	public static String encrypt(String data, String key) throws Exception {
		byte[] bt = encrypt(data.getBytes(), format(key));
